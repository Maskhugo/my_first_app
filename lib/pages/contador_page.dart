...
// Esta tela saiu do main.dart e virou um arquivo só dela.
// Aqui ficam o contador e as telas que dependem do estado dele:
// a meta escolhida, o progresso dessa meta e o resultado dos inputs.
...
class _ContadorProdutividadeState extends State<ContadorProdutividade> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Contador de Inputs')),
